...
| מדבקות | 46×30 | 1 | ₪95 | large_format | 8/31 11:51 — above the sheet → big machine; minimum |
| מדבקות | 70×50 | 1 | ₪95 | large_format | catalog single ₪100 (−5%) |
| מדבקות | 17×56 | 1 | ₪95 | large_format | catalog single ₪95 |
| מדבקות | 100×100 | 1 | ₪125 | large_format | catalog single ₪120 (+4%) |
| מדבקות | 120×80 | 1 | ₪120 | large_format | catalog single ₪120 |
| מדבקות | 130×130 | 1 | ₪155 | large_format | 9/3 08:30 — split above 120, same price; catalog ₪155 |
| מדבקות | 140×140 | 1 | ₪180 | large_format | catalog single ₪180 |
| מדבקות | 115×8 | 10 | ₪950 | large_format | roll is linear: 10 × ₪95 |
...
**מנוע:** שתי מכונות — גיליון / גליל · **קטלוג:** רק שורות מכמות החבילה הקטנה ומעלה קובעות מחיר

**איך נקבע המחיר:**

1. מחיר מאומת בקטלוג לאותה מידה ולאותה כמות נלקח כמות שהוא — לפני כל חישוב
1. שתי מכונות. מדבקה שנכנסת לגיליון הקטן (45.8×30 ס״מ) מתומחרת לפי גיליונות — ₪20 לגיליון לפי כמה נכנסות בגיליון — ולעולם לא יותר מחבילת 100 היחידות של דלי הגודל; מ-100 יחידות המחיר הוא מחירי החבילות של האתר. מדבקה שאינה נכנסת לגיליון מודפסת במדפסת הגדולה (גליל) לפי מ״ר (0+ מ״ר → ₪125 · 1.5+ מ״ר → ₪92) עם מינימום ₪95 ליחידה
1. רוחב הדפסה מרבי 120 ס״מ · מידה רחבה מ-120 ס״מ מסופקת בכמה חלקים — אותו מחיר, כי שטח החומר זהה · גבול ייצור מוחלט 150 ס״מ
1. המחיר לעולם אינו נמוך ממידה מאושרת קטנה יותר (בשני הממדים) באותה כמות — הרצפה הופכת למחיר
1. חומר משנה את המחיר: ויניל בחיתוך צורני +25% · שקוף +15%
1. לבסוף המחיר מעוגל: עד ₪20 לחצי שקל · עד ₪100 לשקל · מעל ₪100 לחמישה שקלים

**הגדרות בתוקף:** מנוע תמחור: שתי מכונות — גיליון / גליל · רוחב הדפסה: 120 ס״מ · גבול ייצור: 150×∞ ס״מ · שטח הדפסה: 45.8×30 ס״מ · גיליון קטן: ₪20 · חבילות מ-100 יח׳ · גליל: מינימום ₪95 ליחידה
