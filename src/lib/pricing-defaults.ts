...
const STICKERS = baseFamilyPricing({
  /* שתי מכונות (לקוח 2026-09-08/09 + הסרטון של ג׳נה):
     ...
     - חבילות האתר (100/150/200/250/500/1000) נשארות: מכמות 100 המחיר הוא
       ...
       (catalog_binds = packs), וכך גם הבודדים לגליל (100×100 = ₪120,
       130×130 = ₪155 …). רק הבודדים שנכנסים לגיליון (30×20 = ₪95 …) אינם
       קובעים עוד — הגיליון מחליף אותם.
     - מדפסת גדולה: מדבקה שאינה נכנסת לדף הקטן — לפי מ״ר על השטח בפועל של כל
       היחידות יחד, ומינימום ₪95 נגבה פעם אחת לעבודה (לקוח 9/23: 4 × 35×35 =
       ₪95, כי כולן נכנסות במטר רבוע). התעריף נקבע לפי גודל המדבקה הבודדת —
       ₪125 עד 1.5 מ״ר ו-₪92 מעליו, ללא מדרגה (ראו areaPrice) (Q2; מכויל
