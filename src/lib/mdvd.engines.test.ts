...
/* ================================ מדבקות ================================ */
/* מנוע `two_machine_sheet`: דף קטן (₪20 לדף, לא יותר מחבילת 100) או מדפסת
   גדולה (לפי מ״ר על השטח בפועל של כל היחידות יחד, מינימום ₪95 לעבודה).
   liveFixture מספק את שורות הקטלוג המאומתות; במדיניות "packs" רק שורות
   מ-100 יח׳ ומעלה, ומדבקות שאינן נכנסות לדף הקטן, קובעות. */
