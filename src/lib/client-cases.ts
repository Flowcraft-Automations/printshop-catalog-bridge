...
export const CLIENT_CASES: ClientCase[] = [
  ...
  /* ---- מדבקות — big page: the roll is billed, ₪95/m², minimum ₪20 ---- */
  { family: "מדבקות", w: 40, h: 40, qty: 1, want: 38, rule: "large_format", source: "9/23 Yulia — one 40×40 uses 100×40 of roll, not 40×40" },
  { family: "מדבקות", w: 50, h: 50, qty: 4, want: 95, rule: "large_format", source: "9/23 Michelle — two across, two rows, exactly one square metre" },
  { family: "מדבקות", w: 50, h: 50, qty: 3, want: 95, rule: "large_format", source: "three fill the same roll piece as four" },
  { family: "מדבקות", w: 51, h: 51, qty: 4, want: 195, rule: "large_format", source: "one centimetre wider and only one fits across the roll" },
  { family: "מדבקות", w: 100, h: 100, qty: 1, want: 95, rule: "large_format", source: "fills the roll exactly — one square metre" },
  { family: "מדבקות", w: 35, h: 35, qty: 1, want: 33, rule: "large_format", source: "100×35 of roll" },
  { family: "מדבקות", w: 35, h: 35, qty: 4, want: 67, rule: "large_format", source: "two across, two rows — 100×70" },
  { family: "מדבקות", w: 46, h: 30, qty: 1, want: 29, rule: "large_format", source: "just over the small page — 100×30 of roll, dearer than a ₪20 page" },
  { family: "מדבקות", w: 46, h: 30, qty: 10, want: 145, rule: "large_format", source: "two across, five rows" },
  { family: "מדבקות", w: 70, h: 50, qty: 1, want: 48, rule: "large_format", source: "100×50 of roll (site says ₪100 — Yulia updates it)" },
  { family: "מדבקות", w: 70, h: 50, qty: 2, want: 67, rule: "large_format", source: "one across, two rows — 100×100 minus nothing" },
  { family: "מדבקות", w: 80, h: 60, qty: 1, want: 57, rule: "large_format", source: "100×60 of roll (site ₪105)" },
  { family: "מדבקות", w: 110, h: 80, qty: 1, want: 91, rule: "large_format", source: "too wide for the 100 roll — billed on the 120 roll" },
  { family: "מדבקות", w: 120, h: 80, qty: 1, want: 91, rule: "large_format", source: "fills the 120 roll (site ₪120)" },
  { family: "מדבקות", w: 130, h: 130, qty: 1, want: 245, rule: "large_format", source: "split in two (9/3); each part wastes the roll width — site ₪155" },
  { family: "מדבקות", w: 140, h: 140, qty: 1, want: 265, rule: "large_format", source: "split in two — site ₪180" },
  { family: "מדבקות", w: 115, h: 8, qty: 1, want: 20, rule: "large_format", source: "job minimum — one small page" },
  { family: "מדבקות", w: 115, h: 8, qty: 10, want: 91, rule: "large_format", source: "stacked ten deep on the 120 roll" },
