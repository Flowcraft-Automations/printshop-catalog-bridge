...
export const CLIENT_CASES: ClientCase[] = [
  ...
  /* ---- מדבקות — roll ---- */
  { family: "מדבקות", w: 46, h: 30, qty: 1, want: 95, rule: "large_format", source: "8/31 11:51 — above the sheet → big machine; minimum" },
  { family: "מדבקות", w: 70, h: 50, qty: 1, want: 95, rule: "large_format", source: "catalog single ₪100 (−5%)" },
  { family: "מדבקות", w: 17, h: 56, qty: 1, want: 95, rule: "large_format", source: "catalog single ₪95" },
  { family: "מדבקות", w: 100, h: 100, qty: 1, want: 125, rule: "large_format", source: "catalog single ₪120 (+4%)" },
  { family: "מדבקות", w: 120, h: 80, qty: 1, want: 120, rule: "large_format", source: "catalog single ₪120" },
  { family: "מדבקות", w: 130, h: 130, qty: 1, want: 155, rule: "large_format", source: "9/3 08:30 — split above 120, same price; catalog ₪155" },
  { family: "מדבקות", w: 140, h: 140, qty: 1, want: 180, rule: "large_format", source: "catalog single ₪180" },
  { family: "מדבקות", w: 115, h: 8, qty: 10, want: 950, rule: "large_format", source: "roll is linear: 10 × ₪95" },
