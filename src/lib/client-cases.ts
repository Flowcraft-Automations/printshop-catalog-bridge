...
export const CLIENT_CASES: ClientCase[] = [
  ...
  { family: "מדבקות", w: 70, h: 50, qty: 1, want: 100, rule: "validated", source: "approved catalog single (roll size)" },
  ...
  { family: "מדבקות", w: 110, h: 100, qty: 1, want: 140, rule: "large_format", source: "no catalog row — roll 1.1 m² × ₪125" },
